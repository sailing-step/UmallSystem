 ...
 <div class="table-bg">
    <el-table :data="goodslist" border>
          ...
          <el-table-column label="商品图片" align="center">
           ...
           <el-table-column prop="price" width="50" label="销售价格" align="center"></el-table-column>
           <el-table-column prop="price" width="50" label="市场价格" align="center"></el-table-column>
          ...
          <el-table-column label="是否热卖" align="center" width="60">
              <template slot-scope="scope">
                   <el-switch v-model="scope.row.ishot" :active-value="1" :inactive-value="2"></el-switch>
              </template>
          </el-table-column>
          <el-table-column label="是否新品" align="center" width="60">
              <template slot-scope="scope">
