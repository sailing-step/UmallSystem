<template>
 <div class="header">
     <div class="lt">
         <el-button type="primary" v-if="iscollapse" @click="TOGGLE" size="small" class="toggle-btn" icon="el-icon-s-unfold"></el-button>
         ...
         <el-button size="small" v-if="$route.path!='/index'"  @click="$router.back()" icon="el-icon-back" circle plain></el-button>
     </div>
     <div>
         <el-dropdown>
